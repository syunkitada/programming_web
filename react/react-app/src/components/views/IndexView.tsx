      ...
      <div className={classes.root}>
        ...
        <DialogActions>
          <div className={classes.wrapper} style={{ width: "100%" }}>
            <Grid container={true}>
              <Grid container={true} item={true} xs={true} justify="flex-start">
                {onClose && (
              ...
              <Grid container={true} item={true} xs={true} justify="flex-end" />
            </Grid>
          </div>
        </DialogActions>
      </div>
          ...
          switch (card.Kind) {
            case "Fields":
              ...
              for (let x = 0, xlen = card.Fields.length; x < xlen; x++) {
                ...
                fields.push(<Field key={x} field={field} data={cardData} />);
              }
              ...
              for (let x = 0, xlen = card.Tables.length; x < xlen; x++) {
                ...
                tables.push(
                  <div key={table.Name}>
                    ...
                    <IndexTable index={table} subData={subData} />
                    <hr />
                  </div>
                );
              }
            ...
            case "Table":
              ...
              cards.push(
                <Grid key={card.Name} item={true} xs={true}>
                  <Typography variant="subtitle1">{card.Name}</Typography>
                  <IndexTable index={card} subData={subData} />
                </Grid>
              );
              break;
          }
...
function mapStateToProps(state, ownProps) {
  ...
  console.log("DEBUG TODO indexView mapStateToProps", Data, index.DataKey);
